...
mod platform {
    #[cfg(target_arch="x86")]
    #[link(name = "fmod_vc")] extern{}
    #[cfg(target_arch="x86_64")]
    #[link(name = "fmod_vc")] extern{}
}

pub const FMOD_VERSION: u32 = 131080;
...
pub const FMOD_OUTPUTTYPE_FMOD_OUTPUTTYPE_MAX: FMOD_OUTPUTTYPE = 19;
pub const FMOD_OUTPUTTYPE_FMOD_OUTPUTTYPE_FORCEINT: FMOD_OUTPUTTYPE = 65536;
pub type FMOD_OUTPUTTYPE = u32;
...
pub const FMOD_SOUNDGROUP_BEHAVIOR_FMOD_SOUNDGROUP_BEHAVIOR_FORCEINT: FMOD_SOUNDGROUP_BEHAVIOR =
    65536;
pub type FMOD_SOUNDGROUP_BEHAVIOR = u32;
...
pub type FMOD_CHANNELCONTROL_DSP_INDEX = i32;
...
pub type FMOD_ERRORCALLBACK_INSTANCETYPE = u32;
...
pub type FMOD_DSP_RESAMPLER = u32;
...
pub type FMOD_DSPCONNECTION_TYPE = u32;
...
fn bindgen_test_layout_FMOD_ADVANCEDSETTINGS() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FMOD_ADVANCEDSETTINGS>())).stackSizeStream as *const _ as usize
        },
        84usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FMOD_ADVANCEDSETTINGS>())).stackSizeNonBlocking as *const _
                as usize
        },
        88usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FMOD_ADVANCEDSETTINGS>())).stackSizeMixer as *const _ as usize
        },
        92usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FMOD_ADVANCEDSETTINGS>())).commandQueueSize as *const _ as usize
        },
        100usize,
        concat!(
            "Offset of field: ",
...
pub type FMOD_DSP_OSCILLATOR = u32;
...
pub type FMOD_DSP_ITLOWPASS = u32;
...
pub type FMOD_DSP_HIGHPASS = u32;
...
pub type FMOD_DSP_NORMALIZE = u32;
...
pub type FMOD_DSP_MULTIBAND_EQ = u32;
...
pub type FMOD_DSP_MULTIBAND_EQ_FILTER_TYPE = u32;
...
pub type FMOD_DSP_PITCHSHIFT = u32;
...
pub type FMOD_DSP_COMPRESSOR = u32;
...
pub type FMOD_DSP_PAN_2D_STEREO_MODE_TYPE = u32;
...
pub type FMOD_DSP_PAN_MODE_TYPE = u32;
...
pub type FMOD_DSP_PAN_3D_ROLLOFF_TYPE = u32;
...
pub type FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE = u32;
...
pub type FMOD_DSP_THREE_EQ_CROSSOVERSLOPE_TYPE = u32;
...
pub type FMOD_DSP_THREE_EQ = u32;
...
pub type FMOD_DSP_FFT_WINDOW = u32;
...
pub type FMOD_DSP_ENVELOPEFOLLOWER = u32;
...
pub type FMOD_DSP_CONVOLUTION_REVERB = u32;
...
pub type FMOD_DSP_CHANNELMIX_OUTPUT = u32;
...
pub type FMOD_DSP_CHANNELMIX = u32;
...
pub type FMOD_DSP_TRANSCEIVER_SPEAKERMODE = i32;
...
pub type FMOD_DSP_TRANSCEIVER = u32;
...
pub type FMOD_DSP_OBJECTPAN = u32;
...
pub type FMOD_DSP_PROCESS_OPERATION = u32;
...
pub type FMOD_DSP_PAN_SURROUND_FLAGS = u32;
...
pub type FMOD_DSP_PARAMETER_TYPE = u32;
...
pub type FMOD_DSP_PARAMETER_FLOAT_MAPPING_TYPE = u32;
...
pub type FMOD_DSP_PARAMETER_DATA_TYPE = i32;
...
pub struct FMOD_OUTPUT_DESCRIPTION {
    ...
    pub name: *const ::std::os::raw::c_char,
    pub version: ::std::os::raw::c_uint,
    pub polling: FMOD_OUTPUT_METHOD,
...
fn bindgen_test_layout_FMOD_OUTPUT_DESCRIPTION() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<FMOD_OUTPUT_DESCRIPTION>())).polling as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(FMOD_OUTPUT_DESCRIPTION),
